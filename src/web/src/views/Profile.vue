          ...
          <table class="profileTable center-horizonally">
            ...
            <tbody>
              <tr>
                <td rowspan="5" class="picture-td">
                  <div class="profile-picture">
                    <el-avatar
                      size="large"
                      :src="getImgUrl(userData.image_large)"
                    >
                      <!--<img src="../assets/notfound.png" />-->
                      <img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlP4HLuTjGwgPOJO2j85GEOgq__zHHJttpwA&usqp=CAU"
                      />
                    </el-avatar>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td v-if="changingName === false">
                  <el-button type="text" @click="changingName = true"
                    >Изменить</el-button
                  >
                </td>
                <td v-if="changingName === true">
              ...
              <tr>
                ...
                <td v-if="changingSurname === true">
                  <el-input
                    ...
                    v-model="newSurname"
                    @input="surnameChanged"
                  ></el-input>
                </td>

                <td v-if="changingSurname === false">
                  <el-button type="text" @click="changingSurname = true"
                    >Изменить</el-button
                  >
                </td>
                <td v-if="changingSurname === true">
                  <el-button-group>
                    <el-button
                      ...
                      icon="el-icon-check"
                      @click="changeSurname"
                      :disabled="!newSurnameValid"
                    ></el-button>
                    <el-button
                      type="warning"
                      icon="el-icon-close"
                      @click="changingSurname = false"
                    ></el-button>
                  </el-button-group>
                </td>
              </tr>
              <tr>
                ...
                <td v-if="changingEmail === false">
                  <el-button type="text" @click="changingEmail = true"
                    >Изменить</el-button
                  >
                </td>
                <td v-if="changingEmail === true">
              ...
              <tr>
                ...
                <td>***********</td>
                <td>
                  <el-button type="text" @click="changingPassword = true"
                    >Изменить</el-button
                  >
                </td>
              </tr>
                ...
                <td>
                  ...
                  >
                    <div class="popover-content">
                      {{
                        join(role.assigned_by_name, role.assigned_by_surname)
                      }}
                    </div>
                    <el-button slot="reference"
                      >@{{ role.assigned_by_username }}</el-button
                    >
                  </el-popover>
                </td>
              </tr>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          :disabled="!passwordData.validForm"
...
export default {
  ...
  methods: {
    changeName: function () {
      ...
      axios
        ...
        .catch(() => {
          this.showError(
            "Изменение данных",
            "Не удалось изменить имя пользоваля"
          );
        });
    },
    changeSurname: function () {
      ...
      axios
        .post(api_url + "/user/change_surname", {
          access_token: localStorage.getItem("access_token"),
        ...
        .then(() => {
          this.showSuccess(
            "Изменение данных",
            "Фамилия пользователя успешно изменено!"
          );
        })
        .catch(() => {
          this.showError(
            "Изменение данных",
            "Не удалось изменить фамилию пользоваля"
          );
        });
    },
    changeEmail: function () {
      ...
      axios
        .post(api_url + "/user/change_email", {
          access_token: localStorage.getItem("access_token"),
        ...
        .then(() => {
          this.showSuccess(
            "Изменение данных",
            "Почта пользователя успешно изменена!"
          );
        })
        .catch(() => {
          this.showError(
            "Изменение данных",
            "Не удалось изменить почту пользоваля"
          );
        });
    },
    changePassword: function () {
      let hash = crypto
        .createHash("sha")
        .update(this.passwordData.newPassword)
        .digest("hex");

      axios
        .post(api_url + "/user/change_password", {
          access_token: localStorage.getItem("access_token"),
        ...
        .catch((error) => {
          ...
          let notificationMessage =
            error.response.data != null ? error.response.data : error;
    ...
    validatePasswordForm: function () {
      if (
        this.validateSimple(this.passwordData.currentPassword) &&
